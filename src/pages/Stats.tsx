...
import { Trophy, Users, Gamepad2, Target, TrendingUp } from 'lucide-react'
    ...
    <div className="container mx-auto px-6 py-12">
      ...
      {activeMainTab === 'soloq' && (
        ...
        >
          ...
          <p className="text-gray-400">Les statistiques Solo Queue seront disponibles bientôt !</p>
        </motion.div>
      )}
      ...
      {!isSupabaseConfigured && (
        ...
        >
          ...
          <p className="text-sm text-gray-300">
            Supabase n'est pas configuré. Configurez Supabase pour accéder aux statistiques
            complètes.
          </p>
        </motion.div>
      )}

            ...
            {stats.recent_matches.map((match, idx) => (
              ...
              >
                <div className="flex-1">
                  <span
                    className={`font-semibold ${match.result === 'win' ? 'text-green-500' : 'text-red-500'}`}
                  >
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {stats.detailed.economy?.gold_per_min || 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Kills/mort</span>
                <span className="font-semibold">
                  {stats.detailed.aggression?.kills_per_death || 'N/A'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">First Blood %</span>
                <span className="font-semibold">
                  {stats.detailed.aggression?.first_blood_rate || 'N/A'}%
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-dark-card border border-dark-border rounded-lg p-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {stats.detailed.objectives?.baron_rate || 'N/A'}%
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Dragon priority</span>
                <span className="font-semibold">
                  {stats.detailed.objectives?.dragon_rate || 'N/A'}%
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">Vision score/min</span>
                <span className="font-semibold">
                  {stats.detailed.vision?.score_per_min || 'N/A'}
                </span>
              </div>
            </div>
          </div>

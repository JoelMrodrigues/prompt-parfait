    ...
    return (
      <div className="max-w-md mx-auto py-16 px-4">
        <div className="bg-dark-card border border-dark-border rounded-xl p-8 text-center">
          ...
          <button onClick={() => navigate('/team')} className="text-accent-blue hover:underline">
            Retour à l'équipe
          </button>
        </div>
      </div>
  ...
  return (
    <div className="max-w-md mx-auto py-16 px-4">
      <div className="bg-dark-card border border-dark-border rounded-xl p-8 text-center space-y-6">
        ...
        <div>
          <h2 className="font-display text-xl font-bold text-white mb-2">Rejoindre l'équipe</h2>
          <p className="text-gray-400 text-sm">
            Vous avez été invité à rejoindre une équipe. Cliquez ci-dessous pour accéder aux
            joueurs, matchs et statistiques.
          </p>
        </div>

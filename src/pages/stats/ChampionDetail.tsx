  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-dark-card border border-dark-border rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <StatRow
              ...
              valueColor={
                general.csd15 > 0 ? 'text-green-500' : general.csd15 < 0 ? 'text-red-500' : ''
              }
            />
            <StatRow
              label="GD@15:"
              ...
              valueColor={
                general.gd15 > 0 ? 'text-green-500' : general.gd15 < 0 ? 'text-red-500' : ''
              }
            />
            <StatRow
              label="XPD@15:"
              ...
              valueColor={
                general.xpd15 > 0 ? 'text-green-500' : general.xpd15 < 0 ? 'text-red-500' : ''
              }
            />
                    ...
                    {roleData ? (
                      <>
                        ...
                        <td className="text-center">
                          <span
                            className={roleData.winrate > 50 ? 'text-green-500' : 'text-red-500'}
                          >
      ...
      {playerStats && playerStats.length > 0 && (
        <div className="bg-dark-card border border-dark-border rounded-lg p-6">
          <h3 className="text-accent-blue font-bold text-lg mb-4">
            BEST {championName.toUpperCase()} PLAYERS
          </h3>
          <table className="w-full">
            <thead>
              <tr className="text-left text-sm text-gray-400 border-b border-dark-border">
              ...
              {playerStats.map((player, idx) => (
                <tr key={idx} className="border-b border-dark-border/50">
                  ...
                  <td className="text-center">
                    <span
                      className={
                        player.csd15 > 0 ? 'text-green-500' : player.csd15 < 0 ? 'text-red-500' : ''
                      }
                    >
...
const MatchListTab = ({ championName, filters, loading, matches }) => {
  ...
  useEffect(() => {
    const loadTeamNames = async () => {
      ...
      uniqueGameIds.forEach((gameid: string) => {
        const map = namesMap as Record<string, string>
        if (!map[gameid]) {
          map[gameid] = gameid
        }
      })
        ...
        <table className="w-full">
          ...
          <tbody>
            {matches.map((match, idx) => {
              ...
              const gameName =
                teamNames[match.gameid] ||
                (Object.keys(teamNames).length > 0 ? 'Loading...' : match.gameid || '-')

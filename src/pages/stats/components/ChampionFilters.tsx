...
export const ChampionFilters = ({
  ...
  const handleSelectGroupLeagues = (groupLeagues) => {
    ...
    if (allSelected) {
      ...
      onFilterChange({
        ...filters,
        leagues: currentLeagues.filter((l) => !groupLeagues.includes(l)),
      })
    } else {
            ...
            {leagueGroups.major.length > 0 && (
              <div className="border-b border-dark-border/50 pb-2 mb-2">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  >
                    {leagueGroups.major.every((l) => (filters.leagues || []).includes(l))
                      ? 'Deselect'
                      : 'All'}
                  </button>
                </div>
                {expandedGroups.major && (
                  <div className="grid grid-cols-2 gap-x-4 gap-y-1 pl-5 mt-1.5">
                    {leagueGroups.major.map((league) => (
                      <label
                        key={league}
                        className="flex items-center gap-1.5 cursor-pointer hover:text-cyan-400 transition-colors py-0.5"
                      >
                        <input
                          type="checkbox"
              ...
              <div className="border-b border-dark-border/50 pb-2 mb-2">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    ...
                    className="text-xs text-cyan-400 hover:text-cyan-300 font-medium"
                  >
                    {leagueGroups.erl.every((l) => (filters.leagues || []).includes(l))
                      ? 'Deselect'
                      : 'All'}
                  </button>
                </div>
              ...
              <div className="border-b border-dark-border/50 pb-2 mb-2">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    ...
                    className="text-xs text-cyan-400 hover:text-cyan-300 font-medium"
                  >
                    {leagueGroups.asia.every((l) => (filters.leagues || []).includes(l))
                      ? 'Deselect'
                      : 'All'}
                  </button>
                </div>
              ...
              <div className="border-b border-dark-border/50 pb-2 mb-2">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    ...
                    className="text-xs text-cyan-400 hover:text-cyan-300 font-medium"
                  >
                    {leagueGroups.americas.every((l) => (filters.leagues || []).includes(l))
                      ? 'Deselect'
                      : 'All'}
                  </button>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    ...
                    className="text-xs text-cyan-400 hover:text-cyan-300 font-medium"
                  >
                    {leagueGroups.others.every((l) => (filters.leagues || []).includes(l))
                      ? 'Deselect'
                      : 'All'}
                  </button>
                </div>

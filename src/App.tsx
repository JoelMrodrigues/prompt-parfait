...
const TeamMembersPage = lazy(() => import('./pages/team/members/TeamMembersPage').then(m => ({ default: m.TeamMembersPage })))
...
const PlansPage = lazy(() => import('./pages/team/plans/PlansPage').then(m => ({ default: m.PlansPage })))

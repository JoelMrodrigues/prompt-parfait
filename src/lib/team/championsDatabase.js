/**
 * Mapping champion ID (Riot API) → nom du champion
 * Utilisé pour parser les matchs Exalty/Riot
 */
export const CHAMPIONS_DATABASE = {
...
/**
 * Convertit un champion ID en nom
 */
export function getChampionNameById(id) {
  const name = CHAMPIONS_DATABASE[id]
  return name || `Unknown_${id}`
}

...
function buildParticipant(p, identity, matchJson, options) {
  ...
  return {
    ...
    stats: {
      ...
      item4: s.item4 || 0,
      item5: s.item5 || 0,
      perk0: getStat(s, 'perk0') || null,
      perk1: getStat(s, 'perk1') || null,
      perk2: getStat(s, 'perk2') || null,
      perk3: getStat(s, 'perk3') || null,
      perk4: getStat(s, 'perk4') || null,
      perk5: getStat(s, 'perk5') || null,
      perkPrimaryStyle: getStat(s, 'perkPrimaryStyle') || getStat(s, 'perk_primary_style') || null,
      perkSubStyle: getStat(s, 'perkSubStyle') || getStat(s, 'perk_sub_style') || null,
    },
    teamId: p.teamId,
